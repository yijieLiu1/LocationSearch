...
public class CiphertextPointInfoHandler implements HttpHandler {
    private DataGenerator dataGenerator;

    public CiphertextPointInfoHandler(DataGenerator dataGenerator) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        if ("GET".equals(exchange.getRequestMethod())) {
            try {
                ...
                String response = mapper.writeValueAsString(dataGenerator.getCiphertextPointInfo());
